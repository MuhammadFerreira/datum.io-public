    ...
    useEffect(() => {
        ...
        const getSurveys = async () => {
            try {
                ...
                setAllSurvey(await UserService.getSurveys(id.id));
        ...
        <div>
            ...
            <main className="main-content position-relative border-radius-lg ">
                ...
                <Snackbar open={openFailure} autoHideDuration={6000} onClose={() => setOpenFailure(false)}
                    ...
                    <Alert severity="error">Unable to Participate In Survey!!</Alert>
                </Snackbar>
                <Snackbar open={openSuccess} autoHideDuration={6000} onClose={() => setOpenSuccess(false)}
                    ...
                    <Alert severity="success">You are now participating in <b>{survey.title}</b></Alert>
                </Snackbar>
                <Modal
                    open={open}
                    survey={survey}
                ...
                >
                    ...
                    {survey &&
                        ...
                        <div className="card shadow-lg mx-4 sticky-sm-top removeoutline" style={{ marginBottom: "20px", paddingTop: "15px", minWidth: "60vw" }}>
                            ...
                            <div className="card-body p-3">
                                ...
                                <div className="row">
                                    <div className="col" style={{ display: "flex", justifyContent: "center" }}>
                                        <button disabled className="btn btn-primary btn-lg" style={{ alignContent: "center", justifyContent: "center" }}>
                                            Participate
                                        </button>
                                    </div>
                                </div>
                                                ...
                                                >
                                                    ...
                                                    <CardCover
                                                        sx={{
                                                            ...
                                                            background:
                                                                'linear-gradient(to top, rgba(0,0,0,0.8), rgba(0,0,0,0) 200px), linear-gradient(to top, rgba(0,0,0,1), rgba(0,0,0,0) 200px)',
                                                        }}
                                                    />
