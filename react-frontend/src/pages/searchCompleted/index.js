...
function SearchCompletedPage() {
    ...
    const surveyTitle = state ? state.surveyTitle : null;
    ...
    useEffect(() => {
        ...
        const getSurveys = async () => {
            try {
                ...
                setAllSurvey(await UserService.getCompletedSurveys(id.id));
            } catch (err) {
                console.error(err);
            }
        };
                        ...
                        <div style={{ justifyContent: 'center', textAlign: 'center', marginLeft: '2rem', marginRight: '2rem', marginBottom: "2rem" }}>
                            ...
                            {listOfSurveys ? listOfSurveys.length > 0 ?
                                <><Grid container rowSpacing={4} columnSpacing={{ xs: 2, sm: 2, md: 2 }}>
                                    {listOfSurveys.filter((survey) => (survey.title?.toLowerCase() + survey.description?.toLowerCase() + survey.tag1?.toLowerCase() + survey.tag2?.toLowerCase() + survey.tag3?.toLowerCase() + survey.creator?.toLowerCase()).includes(query?.toLowerCase())
                                    ).map((survey) => (
                                                ...
                                                >
                                                    <CardCover>
                                                        <img
                                                            ...
                                                            loading="lazy"
                                                            alt="../../assets/img/Datum.io2.png 2x"
                                                    ...
                                                    <CardCover
                                                        sx={{
                                                            ...
                                                            background: 'linear-gradient(to top, rgba(0,0,0,1), rgba(0,0,0,0) 300px)',
                                                        }} />
                                    ...
                                    <Snackbar open={surveyTitle} autoHideDuration={6000}
                                        anchorOrigin={{
                                            vertical: "top",
                                            horizontal: "center"
                                        }} style={{ marginLeft: "5vw" }}>
                                        <Alert severity="success">You Completed <b>{surveyTitle}</b><ConfettiExplosion style={{ marginLeft: "5vw" }} /></Alert>

                                    </Snackbar></> : <div style={{ justifyContent: 'center', textAlign: 'center', marginLeft: '2rem', marginRight: '2rem', marginBottom: "2rem", marginTop: "30vh" }}>
                                    ...
                                    <div className="col-auto">
                                        <div className="d-flex px-2 py-1 w-25">
                                            <a onClick={handleClose} style={{ color: 'white' }}>
                                                <button className="btn btn-danger" style={{ alignContent: "center", justifyContent: "center", marginRight: "20px" }}>
                                                    X
                                                </button>
                                            </a>
                                        </div>
                                ...
                                <div className="card-body p-3">
                                    ...
                                    <div className="row">
                                        <div className="col" style={{ display: "flex", justifyContent: "center" }}>
                                            <a href={`/user/review/survey/${survey.id}`} style={{ color: 'white' }}>
...
export default SearchCompletedPage;