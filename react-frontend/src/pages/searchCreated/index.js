    ...
    useEffect(() => {
        ...
        const getSurveys = async () => {
            try {
                ...
                setAllSurvey(await UserService.getCreatedSurveys(id.id));
            } catch (err) {
                console.error(err);
            }
        };
                                ...
                                <div className="card-body p-3">
                                            ...
                                            <div className="card" style={{ backgroundColor: "black", height: "100%" }}>
                                                ...
                                                <div className="card-body">
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-md-6">
                                                            <div className="form-group">
                                                                <label htmlFor="example-text-input" className="form-control-label" style={{ color: 'red' }}>Deadline</label>
                                                                <br />
                                                                {survey.dueDate}
                                                            </div>
                                                        </div>
                                    ...
                                    <><div className="row">
                                        <div className="col" style={{ display: "flex", justifyContent: "center" }}>
                                            <Link to={`participants/${survey.id}`}>
                                                <div className="d-flex align-items-center">
                                                    <button className="btn btn-secondary btn-lg">Manage Users</button>
                                                </div>
                                            </Link>
                                        </div>
                                    </div>
                                        <div className="row">
                                            <div className="col" style={{ display: "flex", justifyContent: "center" }}>
                                                <Link to={`/user/created/studies/edit/${survey.id}`}>
                                                    <div className="d-flex align-items-center">
...
export default SearchCreatedPage;